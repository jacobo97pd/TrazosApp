...
abstract final class AppTextStyles {
  ...
  static final displayLarge = _base(size: 32, weight: FontWeight.w700, height: 1.15);
  static final displayMedium = _base(size: 26, weight: FontWeight.w700, height: 1.2);
  static final headlineLarge = _base(size: 22, weight: FontWeight.w600, height: 1.25);
  static final headlineMedium = _base(size: 18, weight: FontWeight.w600, height: 1.3);
  ...
  static final bodyLarge   = _base(size: 15, weight: FontWeight.w400, height: 1.5);
  static final bodyMedium  = _base(size: 14, weight: FontWeight.w400, height: 1.5);
  static final labelLarge  = _base(size: 13, weight: FontWeight.w600, letterSpacing: 0.5);
  static final labelMedium = _base(size: 12, weight: FontWeight.w500);
  static final caption     = _base(size: 11, weight: FontWeight.w400, color: AppColors.textSecondary);

  // Variante acento
  static final statNumber = _base(
    size: 36, weight: FontWeight.w700, color: AppColors.accent, letterSpacing: -1,
  );
  static final statLabel = _base(
    size: 11, weight: FontWeight.w500, color: AppColors.textSecondary, letterSpacing: 1.2,
  );
}
  ...
  return ThemeData(
    ...
    elevatedButtonTheme: ElevatedButtonThemeData(
      style: ElevatedButton.styleFrom(
        ...
        textStyle: AppTextStyles.titleMedium.copyWith(fontWeight: FontWeight.w700),
      ),
    ),
    ...
    outlinedButtonTheme: OutlinedButtonThemeData(
      style: OutlinedButton.styleFrom(
        ...
        minimumSize: const Size.fromHeight(52),
        shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(14)),
        textStyle: AppTextStyles.titleMedium.copyWith(fontWeight: FontWeight.w600),
      ),
    ),
